...
\documentclass[french,11pt]{../_header_footer/thesis_x}
\input{../_header_footer/package.tex}
...
\renewcommand{\xpagevalue}{16.4cm}
\newcommand{\xpagevaluedef}{16.6cm}
\newcommand{\xpagevalueloop}{14.2cm}

\input{../_header_footer/livre_begin_no_html_common.tex}
