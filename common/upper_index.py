...
def modify(line, debug):
    ...
    r = re.compile(
        "[{!]?(http://([-\\\\.a-zA-Z0-9_/ ~]*))(}|hyperpage|\\dotfill)?[}]?")
    r = r.search(line)
    ...
    r = r.replace(
        r"\indexentry{SYMBOLES \textit  {PYTHON}@", r"\indexentry{(@")
    ...
    link = ["http:// scintilla.sourceforge.net/ SciTEFAQ.html", "http:// sourceforge.net/ projects/ directpython/ ", "http:// www.die-offenbachs.de/ eric/ index.html", "http://www.gnu.org/software/emacs/windows/", "C:/Python25/Lib/site-packages/PythonSample", "http:// docs.python.org/ dev/ howto/ regex.html", "http:// gnuprog.info/ prog/ python/ pwidget.php", "http://docs.python.org/lib/re-syntax.html", "http://www.xavierdupre.fr/ hal\_python/ hal\_python\_help\_html/ index.html", "paramètres contenant des espaces", "événement associé à une méthode", "Tkinter, séquence d'événéments", "fonctions et chaînes de caractères", "appel à une méthode de l’ancêtre", "http:// docs.python.org/ library/ os.path.html", "http:// docs.python.org/ library/ datetime.html", "http:// sourceforge.net/ projects/ mysql-python", "http:// docs.python.org/ library/ os.path.html", "http://docs.python.org/library/codecs.html\#id3", "http://docs.python.org/library/stdtypes.html#set", "http:// sourceforge.net/ projects/ mysql-python", "http:// sourceforge. net/  projects/  directpython/", "http://docs.python.org/library/stdtypes.html\#id4", "http:// sourceforge. net/ projects/ directpython/", "http:// sourceforge.net/ projects/ mysql-python", "http:// docs.python.org/ library/ os.path.html", "appel à une méthode de l'ancêtre", "zone de saisie à plusieurs lignes", "dictionnaire et clé de type tuple", "Tkinter, séquence d'événements", "héritage multiple et constructeur", "return\_internal\_reference}$", "écriture, lecture de fichier binaire", "import dynamique d’un module"
            ]
