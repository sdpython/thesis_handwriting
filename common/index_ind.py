...
def modify (line, noone = False) :
    ...
    line = line.replace (r"http://www.xavierdupre.fr/hal\_python/hal\_python\_help\_html/sample", r"http://www.xavierdupre.fr/hal\_python/hal\_python\_help\_html/ sample")
    
    line = line.replace (r"CodeWindows\#", r"CodeWindows\# ")
    line = line.replace (r"http://www.stack.nl/$\sim $dimitri/doxygen/", r"http://www. stack. nl/ $\sim $dimitri/ doxygen/")
    line = line.replace (r"http:// www. boost. org/ doc/ libs/ 1\_36\_0/libs/python/doc/index.html", r"http:// www. boost. org/ doc/ libs/ 1\_36\_0/ libs/ python/ doc/ index.html")
    line = line.replace (r"//www.pythonweb.org/projects/webmodules/doc/0.5.3", r"//www.pythonweb.org/projects/webmodules/doc/0.5.3 ")
